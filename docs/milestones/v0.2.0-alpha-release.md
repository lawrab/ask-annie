# Annie's Health Journal - Alpha Release Documentation
...
The 0.2.0-alpha release represents the first production-ready version of Annie's Health Journal following the v0.1.0 MVP. This release focuses on completing the core user journey from authentication through daily check-ins to comprehensive trend analysis.
...
NODE_ENV=production
PORT=3000
MONGODB_URI=mongodb+srv://<username>:<password>@<cluster>.mongodb.net/anniesHealthJournal
...
**Initial Setup:**
1. Create database: `anniesHealthJournal`
...
**Author:** Annie's Health Journal Development Team
**Target Audience:** Alpha testers, stakeholders, beta planning
**Related Documents:**
- [ALPHA_SCOPE.md](/home/lrabbets/repos/annies-health-journal/ALPHA_SCOPE.md) - Detailed scope planning
- [CHANGELOG.md](/home/lrabbets/repos/annies-health-journal/CHANGELOG.md) - Ongoing change log
- [API_DOCUMENTATION.md](/home/lrabbets/repos/annies-health-journal/docs/API_DOCUMENTATION.md) - API reference
- [ARCHITECTURE.md](/home/lrabbets/repos/annies-health-journal/docs/ARCHITECTURE.md) - System architecture
